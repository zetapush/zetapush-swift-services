...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ZetaPushSwift/ZetaPushSwift.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ZetaPushSwiftServices/ZetaPushSwiftServices.framework"
fi
